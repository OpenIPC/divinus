...
enum ConfigError v3_parse_config_lvds(
...
enum ConfigError v3_parse_config_videv(
...
enum ConfigError v3_parse_config_vichn(
...
enum ConfigError v3_parse_config_isp(
...
enum ConfigError v3_parse_sensor_config(char *path, v3_config_impl *config) {
    if (config == NULL)
